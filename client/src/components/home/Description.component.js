            ...
            <Box as='section' p='5'>
                ...
                <Stack mt='3'>
                    ...
                    <p>
                        ...
                        relais de poste du 18è siècle SANS TV (Si! Si ! C'est
                    ...
                    <Button variant="outline" colorScheme="orange" onClick={handleToggle}>{isOpened ? 'Fermer' : 'Lire la suite...'}</Button>
                    <Divider/>
                    {isOpened && (
                    <React.Fragment>
                        <h4>Le logement</h4>
